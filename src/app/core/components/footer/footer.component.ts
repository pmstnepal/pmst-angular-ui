      ...
      <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-1">
            <h3 class="text-2xl font-bold text-white mb-4">PMST</h3>
            <p class="text-sm text-gray-400">US-Nepal Premium Model Showcase and Talent Platform</p>
          </div>
