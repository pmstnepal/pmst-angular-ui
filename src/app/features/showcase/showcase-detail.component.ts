      ...
      @if (lightboxOpen() && gallery()) {
        <div class="lightbox" (click)="closeLightbox()">
          <div class="lightbox-content" (click)="$event.stopPropagation()">
            ...
            <img 
              [src]="imageMapper.mapUrl(gallery()!.images[activeImageIndex()].imageUrl, gallery()!.images[activeImageIndex()].imageKey, 'master')" 
...
export class ShowcaseDetailComponent implements OnInit {
  ...
  private setSeoMeta(gallery: Gallery): void {
    ...
    if (gallery.featuredImage) {
      this.meta.updateTag({ property: 'og:image', content: this.imageMapper.mapUrl(gallery.featuredImage, gallery.imageKey, 'hero') });
    }
    ...
    if (gallery.featuredImage) {
      this.meta.updateTag({ name: 'twitter:image', content: this.imageMapper.mapUrl(gallery.featuredImage, gallery.imageKey, 'hero') });
    }
  }
